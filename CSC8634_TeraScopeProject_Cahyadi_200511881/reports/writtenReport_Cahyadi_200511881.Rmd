...
&nbsp;&nbsp;&nbsp; To help achieving the goals and answer the questions mentioned above, this data mining project would be done using the best practice CRISP-DM methodology, and would be done entirely on R environment supported by the Project Template package and git version control to further streamline the data mining process. 
